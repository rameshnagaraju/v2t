		...
		<div className="mb-1">
			...
			<div className={"text-right py-3"}>
				<button
					...
					disabled={uploading}
					className="inline-block rounded bg-black px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-primary shadow-sm transition duration-150 ease-in-out hover:bg-dark hover:shadow-md disabled:bg-light disabled:cursor-not-allowed">
					{uploading ? 'Please wait...' : 'Send to OpenAI'}
				</button>
			</div>
		</div>
	)
